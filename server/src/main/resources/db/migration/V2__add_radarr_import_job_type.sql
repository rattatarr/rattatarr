...
-- Recreate background_jobs with updated CHECK constraint to include RADARR_IMPORT.
...
CREATE TABLE background_jobs_new (
    ...
    type varchar(255) not null check (type in ('JELLYFIN_SYNC', 'CSV_IMPORT', 'RADARR_IMPORT')),
    primary key (id)
);
