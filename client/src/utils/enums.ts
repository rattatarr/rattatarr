...
export const JOB_TYPE = {
  ...
  JELLYFIN_ACTIVITY_POLL: 'JELLYFIN_ACTIVITY_POLL',
  CSV_IMPORT: 'CSV_IMPORT',
  RADARR_IMPORT: 'RADARR_IMPORT',
  RADARR_RATINGS_REFRESH: 'RADARR_RATINGS_REFRESH',
  RADARR_ANIME_IMPORT: 'RADARR_ANIME_IMPORT',
  RADARR_ANIME_RATINGS_REFRESH: 'RADARR_ANIME_RATINGS_REFRESH',
  SONARR_IMPORT: 'SONARR_IMPORT',
  SONARR_ANIME_IMPORT: 'SONARR_ANIME_IMPORT',
